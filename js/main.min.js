...
if (document.querySelector(".player")) {
    let volumeMute = document.querySelector('.js-controls__btn--mute'), //- Кнопка вкл/выкл звука
    ...
    volumeMute.addEventListener('click', function() {
        ...
        if (volume.dataset.value <= 0) {

            volume.noUiSlider.set(volumeCurrent);
            volume.removeAttribute('disabled');
            volume.classList.remove('range__disabled');

        } else {

            volume.noUiSlider.set(0);
            volume.setAttribute('disabled', true);
            volume.classList.add('range__disabled');
